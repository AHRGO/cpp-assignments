...
void dado_alunos() {
    ...
    */
    ...
    string nome1("MARINA NEVES BEPPLER \u26A1"); //22
    string nome2("VICTOR HUGO FARIAS \u2615"); //20
    int grr1 = 20211593, grr2 = 20193846; //8
    //dados aluno x: -> 18
    //Nome: -> 6 
    //GRR: -> 5
...
void identificacao(string nome, string grr) {
    cout << "\n\n\t\t\t\t\t\t\t" << "\033[4;1;36mNome: " << nome << "  GRR: " << grr << "\033[0m";
...
void tela() {
    header();
    identificacao("Victor Hugo Farias", "20193846");
    linha_cima();
//  Dados apresentados no trabalho semanal 
    linha_baixo();    
    tabuleiro();
